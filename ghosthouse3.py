...
screen = pygame.display.set_mode((600, 650)) #main surface for drawing
...
def background():
    #this fnction paint background of screen
    #backgruond
    rect(screen, screengray, (0, 0, 600, 300))
def clouds_n_stuff():
    #this function draw a moon and nontransparent clouds on screen
    #moon
...
def house(x, y, i, s): #i - coefficient of size, s - name of surface(object pygame.Surface)
    #this function draw house on screen
    #roof
...
def ghost(x, y, i, s): #i - coefficient of size, s - name of surface(object pygame.Surface)
    #this function draw nontransparent ghosts on screen
    #ghost
    #body
...
#surface with transparent - surface, where we place transparent objects
screen2 = pygame.Surface((600,650))
#surface paintng
rect(screen2, (1,1,1),(0,0,600,650))
#houses, transparent ghosts and clouds  
...
#parameters of gradient, value of alpha set the degree of transparent
